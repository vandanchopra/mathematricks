...
start_date = datetime(2023, 10, 14).astimezone(pytz.timezone('US/Eastern'))
end_date = start_date + pd.Timedelta(days=int(365)*3)
...
config_dict = {
    ...
    'strategies':['strategy_dev.crypto.crypto_momentum_last'], # 'pairs_trading', 'strategy_1', 'strategy_dev.strategy_3', 'strategy_3_small_set. strategy_3_1_take_profit_pct
