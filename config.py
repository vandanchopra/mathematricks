...
config_dict = {
    ...
    'backtest_inputs': {
        'start_time': pd.Timestamp(datetime(2024,9,17)).tz_localize('UTC').tz_convert('EST'), 
    ...
    'risk_management':{'max_risk_per_trade':0.05, "total_portfolio" : 200000, "total_funds_s_1" : 100000, "avail_funds_s_1" : 100000, "total_funds_s_2" : 100000, "avail_funds_s_2" : 100000, "max_signal_fund" : 25000},
