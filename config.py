...
start_date = datetime(1995, 3, 1).astimezone(pytz.timezone('US/Eastern'))
end_date = start_date + pd.Timedelta(days=int(365*30))
...
config_dict = {
    ...
    'strategies':['strategy_dev.strategy_3_1'], # 'strategy_1', 'strategy_dev.strategy_3', 'strategy_3_small_set. strategy_3_1_take_profit_pct
