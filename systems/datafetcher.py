...
class DataFetcher:
    def __init__(self, config_dict):
        ...
        self.logger = create_logger(log_level='INFO', logger_name='datafetcher', print_to_console=True)
        self.broker = Brokers()
    
    def fetch_updated_price_data(self, market_data_df, start_date, end_date, lookback, update_data=True):
