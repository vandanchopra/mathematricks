...
class Strategy (BaseStrategy):
    ...
    def datafeeder_inputs(self):
        ...
        tickers = ['MSFT', 'NVDA']
        data_inputs = {'1d': {'columns': ['open', 'high', 'close', 'volume'] , 'lookback':100}, '1m': {'columns': ['open', 'high', 'close', 'volume'] , 'lookback':100}} #'1m': {'columns': ['open', 'high', 'close', 'volume'] , 'lookback':100}
